...
pub struct SkillsConfig {
    ...
    pub enabled: bool,
    /// Directory containing user-placed skills (default: ~/.ferrumyx_runtime_core/skills/).
    /// Skills here are loaded with `Trusted` trust level.
    pub local_dir: PathBuf,
    /// Directory containing registry-installed skills (default: ~/.ferrumyx_runtime_core/installed_skills/).
...
/// Get the default user skills directory (~/.ferrumyx_runtime_core/skills/).
fn default_skills_dir() -> PathBuf {
    runtime_core_base_dir().join("skills")
}

/// Get the default installed skills directory (~/.ferrumyx_runtime_core/installed_skills/).
fn default_installed_skills_dir() -> PathBuf {
    runtime_core_base_dir().join("installed_skills")
}
