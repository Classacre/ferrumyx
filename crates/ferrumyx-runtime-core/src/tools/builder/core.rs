...
impl Default for BuilderConfig {
    fn default() -> Self {
        Self {
            build_dir: std::env::temp_dir().join("ferrumyx_runtime_core-builds"),
            max_iterations: 10,
    ...
    fn test_builder_config_default_sensible_values() {
        ...
        assert!(
            config
                .build_dir
                .to_string_lossy()
                .contains("ferrumyx_runtime_core-builds"),
            "build_dir should contain 'ferrumyx_runtime_core-builds'"
        );
    }
