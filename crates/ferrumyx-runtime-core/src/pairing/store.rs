...
//!
//! Stored in ~/.ferrumyx_runtime_core/{channel}-pairing.json and {channel}-allowFrom.json.
...
impl PairingStore {
    /// Create a new pairing store using default directory (~/.ferrumyx_runtime_core).
    pub fn new() -> Self {
        Self {
