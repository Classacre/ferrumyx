...
#[derive(Parser, Debug)]
#[command(name = "ferrumyx-runtime-core")]
#[command(
    about = "Secure personal AI assistant that protects your data and expands its capabilities"
)]
#[command(
    long_about = "Ferrumyx Runtime Core is a secure AI assistant. Use 'ferrumyx-runtime-core <subcommand> --help' for details.\nExamples:\n  ferrumyx-runtime-core run  # Start the agent\n  ferrumyx-runtime-core config list  # List configs"
)]
#[command(version)]
...
pub enum Command {
    ...
    #[command(
        ...
        long_about = "Starts the Ferrumyx Runtime Core agent in default mode.\nExample: ferrumyx-runtime-core run"
    )]
    Run,
    ...
    #[command(
        ...
        long_about = "Guides through initial configuration.\nExamples:\n  ferrumyx-runtime-core onboard --skip-auth  # Skip auth step\n  ferrumyx-runtime-core onboard --channels-only  # Reconfigure channels\n  ferrumyx-runtime-core onboard --provider-only  # Change LLM provider and model"
    )]
    Onboard {
    ...
    #[command(
        ...
        long_about = "Install, list, or remove WASM-based tools.\nExample: ferrumyx-runtime-core tool install mytool.wasm"
    )]
    Tool(ToolCommand),
    ...
    #[command(
        ...
        long_about = "Interact with extension registry.\nExample: ferrumyx-runtime-core registry list"
    )]
    ...
    #[command(
        ...
        long_about = "Add, auth, list, or test MCP servers.\nExample: ferrumyx-runtime-core mcp add notion https://mcp.notion.com"
    )]
    Mcp(Box<McpCommand>),
    ...
    #[command(
        ...
        long_about = "Search, read, or write to memory.\nExample: ferrumyx-runtime-core memory search 'query'"
    )]
    ...
    #[command(
        ...
        long_about = "Install, start, or stop service.\nExample: ferrumyx-runtime-core service install"
    )]
    ...
    #[command(
        ...
        long_about = "Generates shell completion scripts.\nExample: ferrumyx-runtime-core completion --shell bash > runtime-core.bash"
    )]
