...
/// Convert Ferrumyx Runtime Core `ChatMessage` list into Bedrock system blocks + messages.
///
...
/// Build Bedrock `ToolConfiguration` from Ferrumyx Runtime Core tool definitions.
...
/// Map Bedrock `StopReason` to Ferrumyx Runtime Core `FinishReason`.
