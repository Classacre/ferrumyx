//! Generic adapter that bridges rig-core's `CompletionModel` trait to Ferrumyx Runtime Core's `LlmProvider`.
//!
...
/// Convert Ferrumyx Runtime Core messages to rig-core format.
///
...
/// Convert Ferrumyx Runtime Core tool definitions to rig-core format.
///
...
/// Convert Ferrumyx Runtime Core tool_choice string to rig-core ToolChoice.
...
fn extract_response(
    ...
    for content in choice.iter() {
        match content {
            ...
            // Reasoning and Image variants are not mapped to Ferrumyx Runtime Core types
            _ => {}
        }
    }
