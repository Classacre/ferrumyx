...
//! ```text
//!   ┌─────────────────────┐    ┌──────────────────────────┐
//!   │  providers.json     │    │ ~/.ferrumyx_runtime_core/providers.json│
...
/// from `~/.ferrumyx_runtime_core/providers.json`.
...
impl ProviderRegistry {
    ...
    ///
    /// User providers from `~/.ferrumyx_runtime_core/providers.json` are appended,
...
fn user_providers_path() -> Option<std::path::PathBuf> {
    Some(crate::bootstrap::runtime_core_base_dir().join("providers.json"))
}
