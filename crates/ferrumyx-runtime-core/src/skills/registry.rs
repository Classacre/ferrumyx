...
//! 2. User skills directory (`~/.ferrumyx_runtime_core/skills/`) -- Trusted
//!
...
pub struct SkillRegistry {
    ...
    /// User skills directory (~/.ferrumyx_runtime_core/skills/). Skills here are Trusted.
    user_dir: PathBuf,
    /// Registry-installed skills directory (~/.ferrumyx_runtime_core/installed_skills/). Skills here are Installed.
