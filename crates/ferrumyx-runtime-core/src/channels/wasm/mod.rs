...
//!
//! ```ignore
//! use ferrumyx_runtime_core::channels::wasm::{WasmChannelLoader, WasmChannelRuntime};
//!
...
//! let channels = loader.load_from_dir(Path::new("~/.ferrumyx_runtime_core/channels/")).await?;
//!
