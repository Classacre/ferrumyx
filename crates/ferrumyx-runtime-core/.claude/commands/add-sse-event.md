...
Add a new SSE event called `$ARGUMENTS` to the Ferrumyx Runtime Core web gateway. This involves changes across 5 files in a specific order. Follow each step exactly.
