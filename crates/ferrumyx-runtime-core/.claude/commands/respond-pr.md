...
2. Run Ferrumyx Runtime Core's quality gate to verify nothing breaks:
   - `cargo fmt`
...
- Follow Ferrumyx Runtime Core conventions: no `.unwrap()` in production code, use `crate::` imports, `thiserror` errors.
