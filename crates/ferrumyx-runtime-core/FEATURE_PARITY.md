# Ferrumyx Runtime Core ↔ OpenClaw Feature Parity Matrix

This document tracks feature parity between Ferrumyx Runtime Core (Rust implementation) and OpenClaw (TypeScript reference implementation). Use this to coordinate work across developers.
...
| Feature | OpenClaw | Ferrumyx Runtime Core | Notes |
|---------|----------|----------|-------|
...
| Channel | OpenClaw | Ferrumyx Runtime Core | Priority | Notes |
|---------|----------|----------|----------|-------|
| CLI/TUI | ✅ | ✅ | - | Ratatui-based TUI |
| HTTP webhook | ✅ | ✅ | - | axum with secret validation |
| REPL (simple) | ✅ | ✅ | - | For testing |
| WASM channels | ❌ | ✅ | - | Ferrumyx Runtime Core innovation |
...
| Feature | OpenClaw | Ferrumyx Runtime Core | Notes |
|---------|----------|----------|-------|
| DM pairing codes | ✅ | ✅ | `ferrumyx-runtime-core pairing list/approve`, host APIs |
...
| Command | OpenClaw | Ferrumyx Runtime Core | Priority | Notes |
|---------|----------|----------|----------|-------|
...
| Feature | OpenClaw | Ferrumyx Runtime Core | Notes |
|---------|----------|----------|-------|
| Pi agent runtime | ✅ | ➖ | Ferrumyx Runtime Core uses custom runtime |
...
| Provider | OpenClaw | Ferrumyx Runtime Core | Priority | Notes |
|----------|----------|----------|----------|-------|
...
| Tinfoil | ❌ | ✅ | - | Private inference provider (Ferrumyx Runtime Core-only) |
...
| Feature | OpenClaw | Ferrumyx Runtime Core | Priority | Notes |
|---------|----------|----------|----------|-------|
...
| Workspace-relative install | ✅ | ✅ | ~/.ferrumyx-runtime-core/tools/ |
...
| Hot-reload | ✅ | ❌ | |
| Legacy migration | ✅ | ➖ | |
| State directory | ✅ `~/.openclaw-state/` | ✅ `~/.ferrumyx-runtime-core/` | |
...
| Gemini embeddings | ✅ | ❌ | |
| Local embeddings | ✅ | ❌ | |
| SQLite-vec backend | ✅ | ❌ | Ferrumyx Runtime Core uses PostgreSQL |
...
| DM pairing verification | ✅ | ✅ | ferrumyx-runtime-core pairing approve, host APIs |
| Allowlist/blocklist | ✅ | 🚧 | allow_from + pairing store |
...
| WASM sandbox | ❌ | ✅ | Ferrumyx Runtime Core innovation |
...
- ✅ DM pairing (ferrumyx-runtime-core pairing list/approve, host APIs)
- ✅ WASM tool sandbox
...
Ferrumyx Runtime Core intentionally differs from OpenClaw in these ways:
...
7. **Tinfoil private inference**: Ferrumyx Runtime Core-only provider for private/encrypted inference
