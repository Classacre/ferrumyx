//! Telegram User-Mode WASM Tool for Ferrumyx Runtime Core.
//!
...
//! 2. Store them: `ferrumyx-runtime-core secret set telegram_api_id <id>`
//!    `ferrumyx-runtime-core secret set telegram_api_hash <hash>`
