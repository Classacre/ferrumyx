//! Brave Web Search WASM Tool for Ferrumyx Runtime Core.
//!
...
//! `ferrumyx-runtime-core secret set brave_api_key <key>`
//!
...
fn execute_inner(params: &str) -> Result<String, String> {
    ...
    let headers = serde_json::json!({
        ...
        "User-Agent": "Ferrumyx Runtime Core-WebSearch-Tool/0.1"
    });
