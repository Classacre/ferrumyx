...
mod attachment_tests {
    ...
    use ferrumyx_runtime_core::channels::{AttachmentKind, IncomingAttachment, IncomingMessage};
    use ferrumyx_runtime_core::llm::ContentPart;
    ...
    async fn attachment_audio_transcript_reaches_llm() {
        ...
        let last_user_msg = last_request
            .iter()
            .rev()
            .find(|m| matches!(m.role, ferrumyx_runtime_core::llm::Role::User))
