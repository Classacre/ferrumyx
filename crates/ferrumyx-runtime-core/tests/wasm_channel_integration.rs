...
use ferrumyx_runtime_core::channels::Channel;
use ferrumyx_runtime_core::channels::wasm::{
...
use ferrumyx_runtime_core::pairing::PairingStore;
...
mod loader_tests {
    ...
    async fn test_discover_channels_empty_dir() {
        ...
        let channels = ferrumyx_runtime_core::channels::wasm::discover_channels(dir.path())
            .await
...
mod message_emission_tests {
    use super::*;
    use ferrumyx_runtime_core::channels::wasm::{ChannelHostState, EmittedMessage};
