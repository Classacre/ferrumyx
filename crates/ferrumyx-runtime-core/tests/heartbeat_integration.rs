...
async fn test_heartbeat_end_to_end() {
    ...
    let _ = tracing_subscriber::fmt()
        .with_env_filter("ferrumyx_runtime_core=debug")
        .try_init();
    ...
    let hb_config = ferrumyx_runtime_core::agent::HeartbeatConfig::default();
    let hygiene_config = ferrumyx_runtime_core::workspace::hygiene::HygieneConfig::default();
    ...
    println!("=== Result ===\n");
    match &result {
        ferrumyx_runtime_core::agent::HeartbeatResult::Ok => {
        ...
        ferrumyx_runtime_core::agent::HeartbeatResult::Skipped => {
        ...
        ferrumyx_runtime_core::agent::HeartbeatResult::Failed(err) => {
