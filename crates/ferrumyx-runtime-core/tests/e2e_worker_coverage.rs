...
mod tests {
    ...
    use ferrumyx_runtime_core::context::JobContext;
    use ferrumyx_runtime_core::tools::{Tool, ToolError, ToolOutput};
    ...
    async fn tool_error_feedback() {
        ...
        let fixture_str = fixture_str.replace(
            "/tmp/runtime_core_error_feedback_test/recovered.txt",
