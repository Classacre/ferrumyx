...
mod tests {
    ...
    use ferrumyx_runtime_core::agent::routine::{
        NotifyConfig, Routine, RoutineAction, RoutineGuardrails, Trigger,
    };
    use ferrumyx_runtime_core::agent::routine_engine::RoutineEngine;
    use ferrumyx_runtime_core::agent::{HeartbeatConfig, HeartbeatRunner};
    use ferrumyx_runtime_core::channels::IncomingMessage;
    use ferrumyx_runtime_core::config::RoutineConfig;
    use ferrumyx_runtime_core::db::Database;
    use ferrumyx_runtime_core::workspace::Workspace;
    use ferrumyx_runtime_core::workspace::hygiene::HygieneConfig;
    ...
    async fn heartbeat_findings() {
        ...
        match result {
            ferrumyx_runtime_core::agent::HeartbeatResult::NeedsAttention(msg) => {
                assert!(
                    msg.contains("error"),
    ...
    async fn heartbeat_empty_skip() {
        ...
        let result = runner.check_heartbeat().await;
        assert!(
            matches!(result, ferrumyx_runtime_core::agent::HeartbeatResult::Skipped),
