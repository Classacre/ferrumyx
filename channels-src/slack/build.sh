...
#   - slack-channel.capabilities.json - Capabilities file (copy alongside .wasm)
...
if [ -f "$WASM_PATH" ]; then
    ...
    echo "Copy slack.wasm and slack-channel.capabilities.json to ~/.ferrumyx-runtime-core/channels/"
else
