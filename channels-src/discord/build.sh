...
#   - discord-channel.capabilities.json - Capabilities file (copy alongside .wasm)
...
if [ -f "$WASM_PATH" ]; then
    ...
    echo "  cp discord.wasm discord-channel.capabilities.json ~/.ferrumyx-runtime-core/channels/"
    echo ""
