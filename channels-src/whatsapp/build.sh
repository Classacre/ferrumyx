...
#   - whatsapp-channel.capabilities.json - Capabilities file (copy alongside .wasm)
...
if [ -f "$WASM_PATH" ]; then
    ...
    echo "  cp whatsapp.wasm whatsapp-channel.capabilities.json ~/.ferrumyx-runtime-core/channels/"
    echo ""
