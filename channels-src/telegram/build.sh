...
#   - telegram-channel.capabilities.json - Capabilities file (copy alongside .wasm)
...
if [ -f "$WASM_PATH" ]; then
    ...
    echo "  cp telegram.wasm telegram-channel.capabilities.json ~/.ferrumyx-runtime-core/channels/"
    echo ""
